...
st.markdown(
    """
    <style>
    .stApp { background-color: #E7EBF2; }
    div[data-testid="stVerticalBlock"] > div:has(> div.card-marker) {
        background: #E7EBF2;
        border-radius: 20px;
        padding: 18px 20px;
        box-shadow: 8px 8px 16px #b9c0cf, -8px -8px 16px #ffffff;
    }
    .result-box {
        background:#E7EBF2;
        border-radius:16px;
...
# ===========================================================================
    ...
    if sub.startswith("2.1"):
        ...
        if st.button("Calcular", key="cesar_btn"):
        ...
        if st.button("Calcular", key="vernam_btn"):
            if not key:
        ...
        if st.button("Calcular", key="atbash_btn"):
        ...
        if st.button("Calcular", key="col_btn"):
            if mode == "Cifrar":
        ...
        if st.button("Calcular", key="afin_btn"):
            try:
        ...
        if st.button("Calcular", key="sub_btn"):
...
# ===========================================================================
    ...
    if st.button("Generar hashes con SALT"):
